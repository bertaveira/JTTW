...
from JTTW.modules.encoders.pillar_encoder import PillarEncoder
from JTTW.modules.backbones.second import Backbone, Neck
from JTTW.modules.heads.anchor3d import Head

from JTTW.ops.anchors import Anchors, anchors2bboxes, anchor_target
from JTTW.ops.iou import limit_period
from JTTW.ops.iou3d_gpu import nms_cuda
...
class PointPillars(nn.Module):
    ...
    def forward(self, batched_pts, mode='test', batched_gt_bboxes=None, batched_gt_labels=None):
        ...
        pillar_features = self.pillar_encoder(batched_pts)
